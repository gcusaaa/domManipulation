...
let firstInput = document.querySelector('[data-multiply]')

// 5.2. Attach the second input to a variable
let secondInput = document.querySelector('[data-multiply]')
...
calculateButton1.addEventListener('click', multiplyAndDisplay);
...
let firstModulus = document.querySelector(input)

// 6.2 Set the send modulud input to a variable
let secondModulus = document.querySelector(input)

// 6.3 Set the SECOND span to a varable(will display answer)
let calculateButton1 = document.getElementById('calculate1');

// 6.4 Set the SECOND button to a variable(to run event listener)
let calculateButton2 = document.getElementById('calculate2');
